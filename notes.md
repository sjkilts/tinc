...
project: *flo &011 future
  description:  |
                what does building and funding a hoverboard look like irl
  todo: 
  ...
  notes:
    note: |
          ...
          - we need third party input for the cool stuff.  if we can fund a feasibility report from MIT guys about the ion drive and sound based battery
...
project: *flo &010 wave board
  description: |
                we all want a hoverboard yes?
                ride the wave.
  todo:
  - smart grant
...
project: *flo &009 SMART GRANT
  description:  |
                USDOT grant for transportation related businesses
                due 2022-11-12
  todo:
...
project: *sjk &008 freelance
  description:  |
                freelance projects for funding
                upwork, etc.
  todo:
  - check up on frontend engineer application 2022-10-21
  - finish academic paper illustration 2022-10-21
  notes:
    note: |
          2022-10-20
          |
...
project: *bfa &007 share
  description:  |
                un-gatekeep the alpine
                share and protect the land
                de-centralized access and education
  todo:
...
project: *tnc &006 tinc products
  description:  |
                products for tinc store
  todo:
...
project: *sjk &005 skcom products
  description:  |
                products for skcom store
  todo:
  - rulez metal print, printful sublimation print on metal 16x20


project: *tnc &004 thisisnotculture.us
  description:  |
                this is not culture
                thisisnotculture.us webstore
  todo:
  - determine stack for skcom webstore, follow suite
  - pay for domains for a few years in advance asap


project: *tuv &003 email list 
  description:  |
                email list for tenant union role
                host sign up form to collect emails
...
project: *tuv &002 poster  
  description:  |
                poster for tenants union workshop
                art direction, generate qr code
  todo: 
  - check in, possibly finalized


project: *sjk &001 scottkilts.com
  description:  |
...
minutes: 
- [name, date, client, project, hours, description]
- [*sjk, 2022-10-06, *tuv, *003, 01.00, 'initial setup cc, research landing page']
- [*sjk, 2022-10-06, *tnc, *006, 02.00, 'photoshop decolonize your mind drawing']
- [*sjk, 2022-10-06, *sjk, *001, 03.00, 'notes.yml setup']
- [*sjk, 2022-10-06, *ftl, *012, 02.00, 'site setup, stopped by git error']
- [*sjk, 2022-10-12, *tuv, *003, 01.00, 'site template, approved']
- [*sjk, 2022-10-13, *tuv, *003, 02.00, 'initate jekyll site']
- [*sjk, 2022-10-14, *tuv, *003, 03.00, 'landing page, custom styles']
- [*sjk, 2022-10-15, *tuv, *003, 02.00, 'finalize signup form']
- [*sjk, 2022-10-18, *tuv, *003, 02.00, 'contact page styles']
- [*sjk, 2022-10-18, *tuv, *002, 01.50, 'qr code, poster layout']
- [*sjk, 2022-10-19, *tuv, *003, 01.00, 'cleanup, final styles']
- [*sjk, 2022-10-20, *sjk, *001, 04.50, 'notes.yml setup, notes']
- [*sjk, 2022-10-20, *sjk, *008, 00.50, 'frontend engineer contract']
- [*sjk, 2022-10-20, *sjk, *008, 01.50, 'academic paper illustration']
